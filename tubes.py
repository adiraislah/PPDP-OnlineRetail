# -*- coding: utf-8 -*-
"""
Created on Fri Jan  7 01:25:51 2022
...
for index, row in df.iterrows():
    if (row['Country']=="EIRE"):
        ...
        res_code.append(continent_code)

df ['Continent'] = res_code # masukin list res_code ke dataframe
print (df)

#============BENUA EROPA===============

#filter hanya untuk benua eropa
basket = (df[df['Continent'] =="EU"]
...
rules_apriori_eu2 = rules_apriori_eu[ (rules_apriori_eu['lift'] > 3) & (rules_apriori_eu['confidence'] >= 0.5)]
rules_apriori_eu2.head()
...
fp_rules_eu = association_rules(fpgrowth_frequent_itemsets_eu,  metric="confidence", min_threshold=0.2)
...
rules_apriori_as2 = rules_apriori_as[ (rules_apriori_as['lift'] > 3) & (rules_apriori_as['confidence'] >= 0.5)]
rules_apriori_as.head()
...
#fp_rules_as = association_rules(fpgrowth_frequent_itemsets3,  metric="confidence", min_threshold=0.2)
...
#fp_rules_au = association_rules(fpgrowth_frequent_itemsets3,  metric="confidence", min_threshold=0.2)
